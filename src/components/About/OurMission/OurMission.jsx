...
const OurMission = () => {
  return (
    <div className="bg-gradient-to-bl to-[#1a044d] from-[#080127] mt-20 px-4">
      <div className="max-w-7xl mx-auto text-center p-4">
        ...
        <div className="text-white ">
          <div className="flex bg-gradient-to-bl to-[#0B1120] from-[#080127] p-8 justify-between">
            <div className="text-left md:w-2/4 rounded-2xl">
              <h2 className="uppercase">WHY</h2>
            ...
            <img src={whyImg} alt="" className="w-72 hidden md:block" />
          </div>
          {/*  */}
          <div className="flex gap-5 grid grid-cols-1 md:grid-cols-2 mt-5 ">
            <div className="flex  bg-gradient-to-bl to-[#0B1120] from-[#080127] px-8">
              <div className="text-left p-4">
                <h2 className="uppercase"> what</h2>
                <p className="text-base text-gray-400">
              ...
              <img src={whatImg} alt="" className="w-52 h-52 hidden md:block" />
            </div>
            <div className="flex bg-gradient-to-bl to-[#0B1120] from-[#080127] px-8">
              <div className="text-left p-4">
                <h2 className="uppercase">How</h2>
                <p className="text-base text-gray-400">
              ...
              <img src={howImg} alt="" className="w-52 h-52 hidden md:block" />
            </div>
          </div>
        </div>
      </div>
