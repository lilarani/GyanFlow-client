...
import image7 from "../../../assets/Home/TrustedPartner/fiverr.png";
  ...
  return (
    <>
      <div className="w-full my-28">
        ...
        <p className="text-center text-gray-600 my-3">Collaborating with reliable partners to ensure quality, innovation, and success.</p>
