...
export default function CreateMeeting() {
    ...
    return (
        <div className=" py-10 relative bg-gradient-to-br from-[#1e0033] to-[#4c1d95] flex items-center justify-center px-4 overflow-hidden">
            ...
            >
                ...
                >
                  {user?.name} ,  Welcome to  Our GyanFlow <span className="text-purple-300">ClassMeet </span>
                </motion.h1>

                {
                    user?.role === 'instructor' ? <motion.p
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-sm text-white/70">End-to-end encrypted meetings</p>
                        </div>
                    </motion.div>
                    <motion.div
                        className="bg-white/10 backdrop-blur-md p-4 rounded-xl shadow-xl flex items-center gap-3"
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-sm text-white/70">Join with large team or class</p>
                        </div>
                    </motion.div>
                </div>
