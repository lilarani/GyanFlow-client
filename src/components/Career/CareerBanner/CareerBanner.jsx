...
const CareerBanner = () => {
  return (
    <div className="relative bg-[url('https://i.ibb.co.com/B5KK8mdt/confident-applicant-being-judged-by-interviewing-hr-managers.jpg')] object-cover bg-cover bg-no-repeat w-full min-h-72 md:min-h-[500px]">
      <div className="absolute inset-0 bg-gradient-to-r from-[#100239]/95 to-transparent"></div>
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
        ...
        <div className="text-white space-y-1  md:space-y-3">
          ...
          <button
            ...
            className="flex items-center mx-auto gap-2 my-2 mt-6 p-2 hover:border hover:border-white"
          >
