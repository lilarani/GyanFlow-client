...
const Card = ({ course }) => {
  return (
    <div className="bg-[rgba(0,0,0,0.3)] shadow-2xs  overflow-hidden rounded-2xl p-4 w-full sm:w-[45%] flex  gap-3 relative  course_card">
      <img
        src={course.image}
        alt={course.title}
        className="w-[40%] h-full object-cover rounded-lg  transition-all duration-700 "
      />
...
{/* after hover it will show================ */}
      <div className="flex items-start flex-col justify-start  absolute top-0 bg-main w-full h-full   desc p-3">
