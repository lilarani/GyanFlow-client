...
const WelcomeModal = ({ open, setOpen }) => {
    const slides = [
        { id: 1, text: "Eid Offer: 50% Off on All Courses!", bg: " bg-gradient-to-r from-[#000201] to-transparent", img:image },
        { id: 2, text: "Enroll Now & Get Exclusive Eid Gifts!", bg: " bg-gradient-to-r from-yellow-500 to-transparent", img:image },
        { id: 3, text: "Limited Time Eid Discount: Join Today!", bg: "bg-gradient-to-r from-red-500 to-transparent",img:image },
    ];
            ...
            <div className="w-[100%] h-[100%] mx-auto flex justify-center items-center relative">
                <div className="w-[90%] md:w-[70%] h-[90%] md:h-[60%] mx-auto bg-[#0b1739] text-black rounded-lg shadow-lg flex flex-col justify-center items-center overflow-hidden  ">
                    ...
                    {slides[current] && (
                        ...
                        >
                            <div className={`flex  justify-center items-center gap-4  w-full h-full relative  flex-col  md:flex-row`}>
                                <img src={slides[current]?.img} alt="" className="w-[500px]  h-[250px] object-cover rounded" />
                                <div className="flex gap-3  flex-col">
                                    <h1 className="text-white text-3xl">{slides[current].text}</h1>
                                    <h1 className="text-white text-[14px]">{slides[current].text}</h1>
                                    <div className="w-max">

                                    <Button text="Enroll Now" url="/enroll" />
                                    </div>
                                </div>
                                <img src={image1} alt=""  className="absolute bottom-[-200px]   w-[300px] h-[300px] rotate-45  right-[-70px] -z-0"/>
                           </div>
                        </motion.div>
                    )}                  
                </div>
